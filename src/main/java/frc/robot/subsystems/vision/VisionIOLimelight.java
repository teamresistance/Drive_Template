...
public interface VisionIOLimelight extends Subsystem {

  // Reuse same empirical models as PhotonVision — tune per-camera if needed
  ...
  String LOGGING_KEY_PREFIX = "Limelight/Camera ";
