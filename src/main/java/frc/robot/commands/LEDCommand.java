...
/** 
 * All this command does is add an LEDStream to the LEDSubsystem.
 * It also runs the stream for a specified amount of seconds, 
 * which is necessary for streams that are meant to be temporary.
 */
